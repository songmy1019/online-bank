...
5. 고객이 거래 이력을 조회한다.
6. 고객이 계좌를 폐쇄한다.
7. 고객이 개인정보 인증 대상 업무를 선택한 경우 개인정보 인증을 한다.개인정보 인증 대상 : 입금, 출금, 계좌 개설/폐쇄 


![image](https://user-images.githubusercontent.com/87048759/130161303-6258df71-400f-40a1-91b0-09ccd6029519.png)
